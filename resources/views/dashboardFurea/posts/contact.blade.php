                            ...
                            <div class="contact__info border-radius-10">
                                ...
                                <div class="contact__info--items">
                                    ...
                                    <div class="contact__info--items__inner d-flex">
                                        ...
                                        <div class="contact__info--content">
                                            <p class="contact__info--content__desc text-white"> <a href="mailto:info@example.com">info@tric-indonesia.com</a>
                                        </p> 
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="contact__info--items__inner d-flex">
                                        ...
                                        <div class="contact__info--content">
                                            <p class="contact__info--content__desc text-white">
                                                Grha Savantara – Jl. Anthurium No. 01, Dsn. Banjarsari, Desa Sukoharjo, Kecamatan Ngaglik Kabupaten Sleman, Provinsi D.I. Yogyakarta
                                            </p> 
                                        </div>
                                    </div>
                                </div>
                                <div class="contact__info--items">
                                    ...
                                    <ul class="contact__info--social d-flex">
                                        <li class="contact__info--social__list">
                                            <a class="contact__info--social__icon" target="_blank" href="https://web.facebook.com/TRICIndonesia/">
                                        ...
                                        <li class="contact__info--social__list">
                                            <a class="contact__info--social__icon" target="_blank" href="https://twitter.com/TRIC_online">
                                        ...
                                        <li class="contact__info--social__list">
                                            <a class="contact__info--social__icon" target="_blank" href="https://www.instagram.com/tric_online/">
