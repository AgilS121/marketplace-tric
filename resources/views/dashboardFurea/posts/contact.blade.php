        ...
        <section class="contact__section section--padding">
            <div class="container">
                <div class="section__heading mb-40">
                    ...
                    <p class="contact__section--hrading__desc">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Facere voluptatibus delectus blanditiis rerum, explicabo <br> aspernatur magni nihil distinctio
                        voluptatum quo sit quidem minima repellat sapiente.</p>
                </div>
                                ...
                                <div class="contact__info--items">
                                    ...
                                    <div class="contact__info--items__inner d-flex">
                                        ...
                                        <div class="contact__info--content">
                                            <p class="contact__info--content__desc text-white">Change the design through
                                                a range <br>
                                                <a href="tel:(0274)2874179">(0274)2874179</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="contact__info--items__inner d-flex">
                                        ...
                                        <div class="contact__info--content">
                                            <p class="contact__info--content__desc text-white"> <a
                                                    href="mailto:info@example.com">info@tric-indonesia.com</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="contact__info--items__inner d-flex">
                                        ...
                                        <div class="contact__info--content">
                                            <p class="contact__info--content__desc text-white">
                                                Grha Savantara – Jl. Anthurium No. 01, Dsn. Banjarsari, Desa Sukoharjo,
                                                Kecamatan Ngaglik Kabupaten Sleman, Provinsi D.I. Yogyakarta
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <ul class="contact__info--social d-flex">
                                        ...
                                        <li class="contact__info--social__list">
                                            <a class="contact__info--social__icon" target="_blank"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="19.497"
