...
<head>
  <meta charset="utf-8">
  <title>Furea - Product Left Sidebar</title>
        ...
        <section class="product__details--section  section--padding">
            <div class="container-fluid">
                <div class="row row-md-reverse">
                            @include('dashboardFurea.layouts.sidebar')
                                        ...
                                        <div class="product__details--info">
                                            <form action="#">
                                                ...
                                                <div class="guarantee__safe--checkout">
                                                    ...
                                                    <img class="guarantee__safe--checkout__img" src="{{ asset('Afurea') }}/assets/img/other/safe-checkout.webp" alt="Payment Image">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                            ...
                                            <div class="product__tab--content">
                                                <div class="product__tab--content__items style2 mb-40 d-flex align-items-center">
                                                    <div class="product__tab--content__thumbnail style2">
                                                        <img class="product__tab--content__thumbnail--img display-block" src="{{ asset('Afurea') }}/assets/img/product/product1.webp" alt="product-tab">
                                                    </div>
                                                ...
                                                <div class="product__tab--content__items style2 d-flex align-items-center">
                                                    <div class="product__tab--content__thumbnail style2">
                                                        <img class="product__tab--content__thumbnail--img display-block" src="{{ asset('Afurea') }}/assets/img/product/product2.webp" alt="product-tab">
                                                    </div>
                                                    <div class="product__tab--content__right style2">
                                                        <div class="product__tab--content__step mb-20">
                                                ...
                                                <div class="reviews__comment--area">
                                                    <div class="reviews__comment--list d-flex">
                                                        <div class="reviews__comment--thumbnail">
                                                            <img src="{{ asset('Afurea') }}/assets/img/other/comment-thumb1.webp" alt="comment-thumbnail">
                                                        </div>
                                                    ...
                                                    <div class="reviews__comment--list margin__left d-flex">
                                                        <div class="reviews__comment--thumbnail">
                                                            <img src="{{ asset('Afurea') }}/assets/img/other/comment-thumb2.webp" alt="comment-thumbnail">
                                                        </div>
                                                        <div class="reviews__comment--content">
                                                    ...
                                                    <div class="reviews__comment--list d-flex">
                                                        <div class="reviews__comment--thumbnail">
                                                            <img src="{{ asset('Afurea') }}/assets/img/other/comment-thumb3.webp" alt="comment-thumbnail">
                                                        </div>
                                                        <div class="reviews__comment--content">
                                                            <h4 class="reviews__comment--content__title">Richard Smith</h4>
                                                            <ul class="rating reviews__comment--rating d-flex mb-5">
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="product__items ">
                                                <div class="product__items--thumbnail">
                                                    <a class="product__items--link" href="product-details.html">
                                                        <img class="product__items--img product__primary--img" src="{{ asset('Afurea') }}/assets/img/product/product7.webp" alt="product-img">
                                                        <img class="product__items--img product__secondary--img" src="{{ asset('Afurea') }}/assets/img/product/product8.webp" alt="product-img">
                                                    </a>
                                                    <ul class="product__items--action d-flex justify-content-center">
                                                        <li class="product__items--action__list">
                                                            <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="product__items ">
                                                <div class="product__items--thumbnail">
                                                    <a class="product__items--link" href="product-details.html">
                                                        <img class="product__items--img product__primary--img" src="{{ asset('Afurea') }}/assets/img/product/product9.webp" alt="product-img">
                                                        <img class="product__items--img product__secondary--img" src="{{ asset('Afurea') }}/assets/img/product/product10.webp" alt="product-img">
                                                    </a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">New</span>
                                                    </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="quickview__thumbnail">
                                        <a class="quickview__thumbnail--link" href="product-details.html"><img class="quickview__thumbnail--img" src="{{ asset('Afurea') }}/assets/img/product/big-product2.webp" alt="product-img"></a>
                                        <div class="product__badge">
                                ...
                                <div class="swiper-slide">
                                    <div class="quickview__thumbnail">
                                        <a class="quickview__thumbnail--link" href="product-details.html"><img class="quickview__thumbnail--img" src="{{ asset('Afurea') }}/assets/img/product/big-product3.webp" alt="product-img"></a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">Sale</span>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="quickview__thumbnail">
                                        <a class="quickview__thumbnail--link" href="product-details.html"><img class="quickview__thumbnail--img" src="{{ asset('Afurea') }}/assets/img/product/big-product4.webp" alt="product-img"></a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">Sale</span>
                                        </div>
                                    </div>
                                        ...
                                        <fieldset class="variant__input--fieldset">
                                            ...
                                            <div class="variant__color d-flex">
                                                <div class="variant__color--list">
                                                    ...
                                                    <label class="variant__color--value red" for="color-red5" title="Red"><img class="variant__color--value__img" src="{{ asset('Afurea') }}/assets/img/product/product1.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red6" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red6" title="Black"><img class="variant__color--value__img" src="{{ asset('Afurea') }}/assets/img/product/product6.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red7" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red7" title="Pink"><img class="variant__color--value__img" src="{{ asset('Afurea') }}/assets/img/product/product7.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red8" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red8" title="Orange"><img class="variant__color--value__img" src="{{ asset('Afurea') }}/assets/img/product/product4.webp" alt="variant-color-img"></label>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
