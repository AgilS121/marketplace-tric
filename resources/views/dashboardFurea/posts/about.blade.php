...
<body>
    ...
    <main class="main__content_wrapper">
                ...
                <div class="row">
                        ...
                        <div class="about__thumbnail d-flex">
                            <div class="about__thumbnail--items">
                                <img class="about__thumbnail--img border-radius-5 display-block"
                                    src="{{ asset('Afurea') }}/assets/img/other/about-thumb-list1.webp"
                                    alt="about-thumbnail">
                            </div>
                            <div class="about__thumbnail--items position__relative">
                                <img class="about__thumbnail--img border-radius-5 display-block"
                                    src="{{ asset('Afurea') }}/assets/img/other/about-thumb-list2.webp"
                                    alt="about-thumbnail">
                    ...
                    <div class="col-lg-6">
                        <div class="about__content">
                            ...
                            <h2 class="about__content--maintitle mb-25">We do not buy from the open market & traders.
                            </h2>
                            <p class="about__content--desc mb-20">Lorem ipsum dolor sit amet consectetur adipisicing
                            ...
                            <div class="about__author position__relative">
                                ...
                                <img class="about__author--signature"
                                    src="{{ asset('Afurea') }}/assets/img/icon/signature.webp" alt="signature">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumbnail">
                                    <img class="team__thumbnail--img border-radius-50 display-block"
                                        src="{{ asset('Afurea') }}/assets/img/other/team1.webp" alt="team-thumb">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumbnail">
                                    <img class="team__thumbnail--img border-radius-50 display-block"
                                        src="{{ asset('Afurea') }}/assets/img/other/team2.webp" alt="team-thumb">
                                </div>
                                <div class="team__content">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumbnail">
                                    <img class="team__thumbnail--img border-radius-50 display-block"
                                        src="{{ asset('Afurea') }}/assets/img/other/team3.webp" alt="team-thumb">
                                </div>
                                <div class="team__content">
        ...
        <section class="testimonial__section position__relative testimonial__bg--two section--padding">
                                ...
                                <div class="swiper-wrapper">
                                        ...
                                        <div
                                            ...
                                            <div class="testimonial__thumbnail--style2">
                                                <img class="testimonial__items--thumbnail__img display-block"
                                                    src="{{ asset('Afurea') }}/assets/img/other/testimonial-thumb1.webp"
                                                    alt="testimonial-img">
                                            </div>
                                            <div class="testimonial__content--style2">
                                                ...
                                                <p class="testimonial__items--desc style2"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="8.101"
                                                        height="6.481" viewBox="0 0 8.101 6.481">
                                            ...
                                            <div class="testimonial__quote--icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25.599"
                                                    height="22.572" viewBox="0 0 25.599 22.572">
                                    ...
                                    <div class="swiper-slide">
                                        <div
                                            ...
                                            <div class="testimonial__thumbnail--style2">
                                                <img class="testimonial__items--thumbnail__img display-block"
                                                    src="{{ asset('Afurea') }}/assets/img/other/testimonial-thumb2.webp"
                                                    alt="testimonial-img">
                                            </div>
                                            <div class="testimonial__content--style2">
                                    ...
                                    <div class="swiper-slide">
                                        <div
                                            ...
                                            <div class="testimonial__thumbnail--style2">
                                                <img class="testimonial__items--thumbnail__img display-block"
                                                    src="{{ asset('Afurea') }}/assets/img/other/testimonial-thumb3.webp"
                                                    alt="testimonial-img">
                                            </div>
                                            <div class="testimonial__content--style2">
            ...
            <img class="testimonial__bg--shape1" src="{{ asset('Afurea') }}/assets/img/other/testimonial-shape.webp"
                alt="">
            <img class="testimonial__bg--shape2" src="{{ asset('Afurea') }}/assets/img/other/testimonial-shape2.webp"
                alt="">
        </section>
