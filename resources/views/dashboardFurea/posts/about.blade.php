   ...
   <header class="header__section header__others border-bottom header__transparent mb-30">
    ...
    <main class="main__content_wrapper">
                    ...
                    <div class="col-lg-6">
                        <div class="about__thumbnail d-flex">
                            <div class="about__thumbnail--items">
                                <img class="about__thumbnail--img border-radius-5 display-block" src="{{ asset('Afurea') }}/assets/img/other/about-thumb-list1.webp" alt="about-thumbnail">
                            </div>
                            <div class="about__thumbnail--items position__relative">
                                <img class="about__thumbnail--img border-radius-5 display-block" src="{{ asset('Afurea') }}/assets/img/other/about-thumb-list2.webp" alt="about-thumbnail">
                    ...
                    <div class="col-lg-6">
                        <div class="about__content">
                            ...
                            <div class="about__author position__relative">
                                ...
                                <img class="about__author--signature" src="{{ asset('Afurea') }}/assets/img/icon/signature.webp" alt="signature">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="team__container">
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumbnail">
                                    <img class="team__thumbnail--img border-radius-50 display-block" src="{{ asset('Afurea') }}/assets/img/other/team1.webp" alt="team-thumb">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumbnail">
                                    <img class="team__thumbnail--img border-radius-50 display-block" src="{{ asset('Afurea') }}/assets/img/other/team2.webp" alt="team-thumb">
                                </div>
                                <div class="team__content">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumbnail">
                                    <img class="team__thumbnail--img border-radius-50 display-block" src="{{ asset('Afurea') }}/assets/img/other/team3.webp" alt="team-thumb">
                                </div>
                                <div class="team__content">
        ...
        <section class="testimonial__section position__relative testimonial__bg--two section--padding">
                            ...
                            <div class=" testimonial__swiper--column3 testimonial__padding swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="testimonial__items--style2 position__relative border-radius-5 d-flex align-items-center">
                                            <div class="testimonial__thumbnail--style2">
                                                <img class="testimonial__items--thumbnail__img display-block" src="{{ asset('Afurea') }}/assets/img/other/testimonial-thumb1.webp" alt="testimonial-img">
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial__items--style2 position__relative border-radius-5 d-flex align-items-center">
                                            <div class="testimonial__thumbnail--style2">
                                                <img class="testimonial__items--thumbnail__img display-block" src="{{ asset('Afurea') }}/assets/img/other/testimonial-thumb2.webp" alt="testimonial-img">
                                            </div>
                                            <div class="testimonial__content--style2">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial__items--style2 position__relative border-radius-5 d-flex align-items-center">
                                            <div class="testimonial__thumbnail--style2">
                                                <img class="testimonial__items--thumbnail__img display-block" src="{{ asset('Afurea') }}/assets/img/other/testimonial-thumb3.webp" alt="testimonial-img">
                                            </div>
                                            <div class="testimonial__content--style2">
            ...
            <img class="testimonial__bg--shape1" src="{{ asset('Afurea') }}/assets/img/other/testimonial-shape.webp" alt="">
            <img class="testimonial__bg--shape2" src="{{ asset('Afurea') }}/assets/img/other/testimonial-shape2.webp" alt="">
        </section>
        ...
        <section class="newsletter__banner--section section--padding">
            <div class="container">
                <div class="newsletter__banner--thumbnail position__relative">
                    <img class="newsletter__banner--thumbnail__img" src="{{ asset('Afurea') }}/assets/img/banner/banner-bg7.webp" alt="newsletter-banner">
