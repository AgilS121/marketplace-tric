                            ...
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html">
                                        <img class="blog__thumbnail--img display-block"
                                            src="https://source.unsplash.com/320x218?wood&furniture" alt="blog-img"></a>
                                </div>
                                <div class="blog__content text-center">
                                    ...
                                    <a class="blog__content--btn primary__btn btn__style3" href="blog-details.html">Read
                                        more </a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html">
                                        <img class="blog__thumbnail--img display-block"
                                            src="https://source.unsplash.com/320x218?metal&furniture"
                                            alt="blog-img"></a>
                                </div>
                                <div class="blog__content text-center">
                                    <ul class="blog__content--meta d-flex justify-content-center">
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html">
                                        <img class="blog__thumbnail--img display-block"
                                            src="https://source.unsplash.com/320x218?bamboo&furniture"
                                            alt="blog-img"></a>
                                </div>
                                <div class="blog__content text-center">
                                    <ul class="blog__content--meta d-flex justify-content-center">
                                    ...
                                    <p class="blog__content--desc">Mum ut perspiciatis unde omnis iste
                                        natus error sit voluptatem…..</p>
                                    <a class="blog__content--btn primary__btn btn__style3"
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html">
                                        <img class="blog__thumbnail--img display-block"
                                            src="https://source.unsplash.com/320x218?classic&furniture"
                                            alt="blog-img"></a>
                                </div>
                                <div class="blog__content text-center">
                                    <ul class="blog__content--meta d-flex justify-content-center">
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html">
                                        <img class="blog__thumbnail--img display-block"
                                            src="https://source.unsplash.com/320x218?modern&furniture"
                                            alt="blog-img"></a>
                                </div>
                                <div class="blog__content text-center">
                                    <ul class="blog__content--meta d-flex justify-content-center">
