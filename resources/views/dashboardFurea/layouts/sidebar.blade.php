            ...
            <ul class="widget__categories--menu">
                <li class="widget__categories--menu__list">
                    <label class="widget__categories--menu__label d-flex align-items-center">
                        <img class="widget__categories--menu__img" src="https://source.unsplash.com/100x105?denim&jacket" alt="categories-img">
                ...
                <li class="widget__categories--menu__list">
                    <label class="widget__categories--menu__label d-flex align-items-center">
                        <img class="widget__categories--menu__img" src="https://source.unsplash.com/100x105?oversize&cotton" alt="categories-img">
                ...
                <li class="widget__categories--menu__list">
                    <label class="widget__categories--menu__label d-flex align-items-center">
                        <img class="widget__categories--menu__img" src="https://source.unsplash.com/100x105?dairy&chesse" alt="categories-img">
                ...
                <li class="widget__categories--menu__list">
                    <label class="widget__categories--menu__label d-flex align-items-center">
                        <img class="widget__categories--menu__img" src="https://source.unsplash.com/100x105?shoulder&bag" alt="categories-img">
        ...
        <div class="single__widget widget__bg">
            ...
            <div class="product__grid--inner">
                <div class="product__items product__items--grid d-flex align-items-center">
                    <div class="product__items--grid__thumbnail position__relative">
                        <a class="product__items--link" href="product-details.html">
                            <img class="product__items--img product__primary--img" src="https://source.unsplash.com/100x105?chair&modern" alt="product-img">
                            <img class="product__items--img product__secondary--img" src="https://source.unsplash.com/100x105?modern&chair" alt="product-img">
                        </a>
                    </div>
                ...
                <div class="product__items product__items--grid d-flex align-items-center">
                    <div class="product__items--grid__thumbnail position__relative">
                        <a class="product__items--link" href="product-details.html">
                            <img class="product__items--img product__primary--img" src="https://source.unsplash.com/100x105?chair&plastic" alt="product-img">
                            <img class="product__items--img product__secondary--img" src="https://source.unsplash.com/100x105?plastic&chair" alt="product-img">
                        </a>
                    </div>
                    <div class="product__items--grid__content">
                ...
                <div class="product__items product__items--grid d-flex align-items-center">
                    <div class="product__items--grid__thumbnail position__relative">
                        <a class="product__items--link" href="product-details.html">
                            <img class="product__items--img product__primary--img" src="https://source.unsplash.com/100x105?design&room" alt="product-img">
                            <img class="product__items--img product__secondary--img" src="https://source.unsplash.com/100x105?room&design" alt="product-img">
                        </a>
                    </div>
                    <div class="product__items--grid__content">
