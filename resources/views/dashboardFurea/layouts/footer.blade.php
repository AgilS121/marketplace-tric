    ...
    <div class="container">
        <div class="main__footer">
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer__widget">
                        ...
                        <div class="footer__widget--inner">
                            <a class="footer__logo" href="index.html"><img src="img/LogoTRIC.png" alt="footer-logo"></a>
                            <p class="footer__widget--desc">PT Trifos Internasional Sertfikasi (TRIC) adalah perusahaan jasa professional bidang sertifikasi, pelatihan dan pengujian. Perusahaan ini didirikan secara resmi pada Tahun 2015 sesuai dengan Akta Pendirian Nomor 08 oleh Notaris Sumendro, S.H di Yogyakarta.</p>
                            <div class="footer__social">
                                <ul class="social__shear d-flex">
                                    <li class="social__shear--list">
                                        <a class="social__shear--list__icon" target="_blank" href="https://web.facebook.com/TRICIndonesia/">
                                    ...
                                    <li class="social__shear--list">
                                        <a class="social__shear--list__icon" target="_blank" href="https://twitter.com/TRIC_online">
                                    ...
                                    <li class="social__shear--list">
                                        <a class="social__shear--list__icon" target="_blank" href="https://www.instagram.com/tric_online/">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer__widget">
                        <h2 class="footer__widget--title ">Link Tautan Cepat <button class="footer__widget--button" aria-label="footer widget button"></button>
                            <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                            </svg>
                        </h2>
                        <ul class="footer__widget--menu footer__widget--inner">
                            ...
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="/privacyPolicy">Privacy Policy</a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer__widget">
                        <h2 class="footer__widget--title ">Info Akun <button class="footer__widget--button" aria-label="footer widget button"></button>
                            <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                            </svg>
                        </h2>
                        <ul class="footer__widget--menu footer__widget--inner">
                            ...
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="/loginb">Login</a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer__widget">
                        <h2 class="footer__widget--title ">Hubungi Kami <button class="footer__widget--button" aria-label="footer widget button"></button>
                            <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                            </svg>
                        </h2>
                        <div class="footer__contact--info footer__widget--inner">
                            <ul class="footer__contact--info__inner">
                                <li class="footer__contact--info__text"><strong>Address:</strong> Grha Savantara – Jl. Anthurium No. 01, Dsn. Banjarsari, Desa Sukoharjo, Kecamatan Ngaglik Kabupaten Sleman, Provinsi D.I. Yogyakarta</li>
                                <li class="footer__contact--info__text"><strong>Email:</strong> <a href="info@tric-indonesia.com">info@tric-indonesia.com</a></li>
                                <li class="footer__contact--info__text"><strong>Phone:</strong> <a href="tel:(0274) 2874179">(0274) 2874179 </a></li>
                            </ul> 
                            <div class="footer__payment--method">
                                <h3 class="footer__payment--method__title">Sistem Metode Pembayaran</h3>
                                <img class="footer__payment--visa__card display-block" src="{{ asset('Afurea') }}/assets/img/other/payment-visa-card.webp" alt="visa-card">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer__bottom text-center">
            <p class="copyright__content">Copyright © 2022 <a class="copyright__content--link" href="index.html">AFurea</a> . All Rights Reserved.Design By AFurea</p>
        </div>
    </div>
</footer>
<!-- End footer section -->