        ...
        <div class="container">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="/furea"><img class="main__logo--img" width="150px" src="img/LogoTRIC.png" alt="logo-img"></a></h1>
                </div>
                <div class="header__menu d-none d-lg-block">
                    <nav class="header__menu--navigation style3">
                        <ul class="d-flex justify-content-center">
                            <li class="header__menu--items style3">
                                <a class="header__menu--link style3" href="/furea">Home <span class="menu__plus--icon"></span></a>
                            </li>
                            <li class="header__menu--items mega__menu--items style3">
                                <a class="header__menu--link style3" href="/shopfurea">Shop <span class="menu__plus--icon"></span></a>
                            ...
                            <li class="header__menu--items style3">
                                <a class="header__menu--link style3" href="/blog">Blog <span class="menu__plus--icon"></span> </a>
                            </li>
                            <li class="header__menu--items style3">
                                ...
                                <ul class="header__sub--menu">
                                    ...
                                    <li class="header__sub--menu__items"><a href="/loginb" class="header__sub--menu__link">Login Page</a></li>
        ...
        <div class="offcanvas__inner">
            <div class="offcanvas__logo">
                <a class="offcanvas__logo_link" href="index.html">
                    <img src="{{ asset('Afurea') }}/assets/img/logo/nav-log3.webp" alt="AFurea Logo">
                </a>
                    ...
                    <ul class="d-flex align-items-center">
                        <li class="language__currency--list">
                            <a class="offcanvas__language--switcher" href="#">
                                <img class="language__switcher--icon__img" src="{{ asset('Afurea') }}/assets/img/icon/language-icon.webp" alt="currency">
                                <span>English</span> 
                        ...
                        <li class="language__currency--list">
                            <a class="offcanvas__account--currency__menu" href="#">
                                <img src="{{ asset('Afurea') }}/assets/img/icon/usd-icon.webp" alt="currency">
                                <span>$ US Dollar</span> 
                                <svg xmlns="http://www.w3.org/2000/svg" width="11.797" height="9.05" viewBox="0 0 9.797 6.05">
                                    <path  d="M14.646,8.59,10.9,12.329,7.151,8.59,6,9.741l4.9,4.9,4.9-4.9Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                </svg>
        ...
        <div class="minicart__product">
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumbnail">
                    <a href="product-details.html"><img src="{{ asset('Afurea') }}/assets/img/product/product1.webp" alt="prduct-img"></a>
                </div>
            ...
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumbnail">
                    <a href="product-details.html"><img src="{{ asset('Afurea') }}/assets/img/product/product2.webp" alt="prduct-img"></a>
                </div>
                <div class="minicart__text">
