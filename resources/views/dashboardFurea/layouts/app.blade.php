                ...
                <div class="header__topbar--inner header__topbar--inner2 d-flex align-items-center justify-content-between">
                    <ul class="header__info d-flex align-items-center">
                        <li class="header__info--list">
                          ...
                          <a class="header__info--text" href="tel:02742874179">(0274) 2874179 </a>
                        </li>
                        <li class="header__info--list">
                          ...
                          <a class="header__info--text" href="info@tric-indonesia.com">info@tric-indonesia.com</a>
                        </li>
                ...
                <div class="categories__section--inner">
                    <div class="row row-cols-lg-6 row-cols-md-4 row-cols-sm-3 row-cols-2  mb--n30">
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('Afurea') }}/assets/img/product/categories-product1.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('Afurea') }}/assets/img/product/categories-product2.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('Afurea') }}/assets/img/product/categories-product3.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('Afurea') }}/assets/img/product/categories-product4.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('Afurea') }}/assets/img/product/categories-product5.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('Afurea') }}/assets/img/product/categories-product6.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('Afurea') }}/assets/img/product/categories-product7.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('Afurea') }}/assets/img/product/categories-product8.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('Afurea') }}/assets/img/product/categories-product9.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('Afurea') }}/assets/img/product/categories-product10.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('Afurea') }}/assets/img/product/categories-product11.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('Afurea') }}/assets/img/product/categories-product12.webp" alt="categories-product">
                            ...
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        ...
                                        <img class="product__items--img product__primary--img" src="https://source.unsplash.com/282x295?Design" alt="Design">
                                        
                                        <img class="product__items--img product__secondary--img" src="https://source.unsplash.com/282x295?cardesign" alt="Design">
                                ...
                                <div class="product__items--content text-center">
                                    ...
                                    <h3 class="product__items--content__title h4"><a href="product-details.html">{{ $item->nama_barang }}</a></h3>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-7">
                        <div class="choiceus__banner position__relative d-flex">
                            <a class="choiceus__banner--thumbnail one display-block" href="shop.html" rel="nofollow"><img class="choiceus__banner--thumbnail__img display-block" src="https://source.unsplash.com/458x575?modern&room" alt="banner-img"></a>
                            <a class="choiceus__banner--thumbnail two display-block" href="shop.html" rel="nofollow"><img class="choiceus__banner--thumbnail__img two display-block" src="https://source.unsplash.com/361x467?minimalis&room" alt="banner-img"></a>
                    ...
                    <div class="row row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30">
                        <div class="col mb-30">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">                                       
                                        <img class="product__items--img product__primary--img" src="https://source.unsplash.com/282x295?Chair" alt="Design">                                      
                                        <img class="product__items--img product__secondary--img" src="https://source.unsplash.com/282x295?table" alt="Design">
                            ...
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        ...
                                        <img class="product__items--img product__primary--img" src="https://source.unsplash.com/282x295?lamp" alt="Design">                                      
                                        <img class="product__items--img product__secondary--img" src="https://source.unsplash.com/282x295?modern" alt="Design">
                                        {{-- <img class="product__items--img product__primary--img" src="{{ asset('Afurea') }}/assets/img/product/product13.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('Afurea') }}/assets/img/product/product14.webp" alt="product-img"> --}}
                                    </a>
                                    <div class="product__badge style3">
                                        <span class="product__badge--items style3 sale">New</span>
                                    </div>
                        ...
                        <div class="col mb-30">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">                                       
                                        <img class="product__items--img product__primary--img" src="https://source.unsplash.com/282x295?plastic" alt="Design">                                      
                                        <img class="product__items--img product__secondary--img" src="https://source.unsplash.com/282x295?minimalis" alt="Design">
                                        {{-- <img class="product__items--img product__primary--img" src="{{ asset('Afurea') }}/assets/img/product/product15.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('Afurea') }}/assets/img/product/product1.webp" alt="product-img"> --}}
                                    </a>
                                    <ul class="product__items--action d-flex justify-content-center">
                                        <li class="product__items--action__list">
                                            <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                        ...
                        <div class="col mb-30">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">                                       
                                        <img class="product__items--img product__primary--img" src="https://source.unsplash.com/282x295?sofa" alt="Design">                                      
                                        <img class="product__items--img product__secondary--img" src="https://source.unsplash.com/282x295?classic" alt="Design">
                                        {{-- <img class="product__items--img product__primary--img" src="{{ asset('Afurea') }}/assets/img/product/product14.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('Afurea') }}/assets/img/product/product2.webp" alt="product-img"> --}}
                                    </a>
                                    <div class="product__badge style3">
                                        <span class="product__badge--items style3 sale">New</span>
                            ...
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        ...
                                        <img class="product__items--img product__primary--img" src="https://source.unsplash.com/282x295?fashion" alt="Design">                                      
                                        <img class="product__items--img product__secondary--img" src="https://source.unsplash.com/282x295?modern" alt="Design">
                                        {{-- <img class="product__items--img product__primary--img" src="{{ asset('Afurea') }}/assets/img/product/product6.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('Afurea') }}/assets/img/product/product5.webp" alt="product-img"> --}}
                                    </a>
                                    <div class="product__badge style3">
                                        <span class="product__badge--items style3 sale">New</span>
                                    </div>
                            ...
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        ...
                                        <img class="product__items--img product__primary--img" src="https://source.unsplash.com/282x295?Chair" alt="Design">                                      
                                        <img class="product__items--img product__secondary--img" src="https://source.unsplash.com/282x295?living" alt="Design">
                                        {{-- <img class="product__items--img product__primary--img" src="{{ asset('Afurea') }}/assets/img/product/product1.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('Afurea') }}/assets/img/product/product2.webp" alt="product-img"> --}}
                                    </a>
                                    <div class="product__badge style3">
                        ...
                        <div class="col mb-30">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">                                       
                                        <img class="product__items--img product__primary--img" src="https://source.unsplash.com/282x295?swivel" alt="Design">                                      
                                        <img class="product__items--img product__secondary--img" src="https://source.unsplash.com/282x295?Chair" alt="Design">
                                        {{-- <img class="product__items--img product__primary--img" src="{{ asset('Afurea') }}/assets/img/product/product3.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('Afurea') }}/assets/img/product/product4.webp" alt="product-img"> --}}
                                    </a>
                                    <ul class="product__items--action d-flex justify-content-center">
                                        <li class="product__items--action__list">
                                            <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                            ...
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">                                       
                                        <img class="product__items--img product__primary--img" src="https://source.unsplash.com/282x295?sofa" alt="Design">                                      
                                        <img class="product__items--img product__secondary--img" src="https://source.unsplash.com/282x295?living" alt="Design">
                                        {{-- <img class="product__items--img product__primary--img" src="{{ asset('Afurea') }}/assets/img/product/product5.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('Afurea') }}/assets/img/product/product6.webp" alt="product-img"> --}}
                                    </a>
                                    <div class="product__badge style3">
                                        <span class="product__badge--items style3 sale">New</span>
                                    </div>
                ...
                <div class="row row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 mb--n28">
                    <div class="col mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.html">
                                <img class="banner__items--thumbnail__img" src="https://source.unsplash.com/370x195?elegant" alt="banner-img">
                    ...
                    <div class="col mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.html">
                                <img class="banner__items--thumbnail__img" src="https://source.unsplash.com/370x195?classic" alt="banner-img">
                                <div class="banner__content--style3">
                                    <h2 class="banner__content--style3__title">Blue Elegant <br>
                                        Chair
                                    </h2>
                    ...
                    <div class="col mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.html">
                                <img class="banner__items--thumbnail__img" src="https://source.unsplash.com/370x195?modern" alt="banner-img">
                                <div class="banner__content--style3">
                                    <h2 class="banner__content--style3__title">Blue Elegant <br>
                                        Chair
                                    </h2>
        ...
        <div class="deals__banner--section color-scheme-3 section--padding pt-0">
            <div class="container">
                <div class="deals__banner--thumbnail mt-0">
                    <a class="deals__banner--thumbnail__link display-block position__relative" href="shop.html">
                        <img class="deals__banner--thumbnail__img style2 display-block" src="https://source.unsplash.com/370x195?minimalis" alt="deals-thumbnail-img ">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="product__items new__product--items border">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img" src="https://source.unsplash.com/249x277?classic&chair" alt="product-img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="product__items new__product--items border">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img" src="https://source.unsplash.com/249x277?minimalis&chair" alt="product-img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="product__items new__product--items border">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img" src="https://source.unsplash.com/249x277?modern&chair" alt="product-img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="product__items new__product--items border">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img" src="https://source.unsplash.com/249x277?fabric&chair" alt="product-img">
                                        </a>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="newsletter__banner--section section--padding color-scheme-3">
            <div class="container">
                <div class="newsletter__banner--thumbnail position__relative">
                    <img class="newsletter__banner--thumbnail__img" src="https://source.unsplash.com/1170x341?elegant&chair" alt="newsletter-banner">
                                ...
                                <div class="swiper-wrapper">
                                        ...
                                        <div class="testimonial__items--style3 border-radius-5">
                                            <div class="testimonial__style3--topbar text-center">
                                                <div class="testimonial__thumbnail--style3">
                                                    <img class="testimonial__thumbnail--style3__img display-block" src="https://source.unsplash.com/102x102?product&designer" alt="testimonial-img">
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial__items--style3 border-radius-5">
                                            <div class="testimonial__style3--topbar text-center">
                                                <div class="testimonial__thumbnail--style3">
                                                    <img class="testimonial__thumbnail--style3__img display-block" src="https://source.unsplash.com/102x102?photos&designer" alt="testimonial-img">
                                                </div>
                                                <div class="testimonial__style3--author">
                                                    <h3 class="testimonial__style3--author__title h4">Robert Bruze</h3>
                                                    <h4 class="testimonial__style3--author__subtitle h5">Product Designer</h4>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial__items--style3 border-radius-5">
                                            <div class="testimonial__style3--topbar text-center">
                                                <div class="testimonial__thumbnail--style3">
                                                    <img class="testimonial__thumbnail--style3__img display-block" src="https://source.unsplash.com/102x102?photos&beautiful" alt="testimonial-img">
                                                </div>
                                                <div class="testimonial__style3--author">
                                                    <h3 class="testimonial__style3--author__title h4">Robert Bruze</h3>
                                                    <h4 class="testimonial__style3--author__subtitle h5">Product Designer</h4>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial__items--style3 border-radius-5">
                                            <div class="testimonial__style3--topbar text-center">
                                                <div class="testimonial__thumbnail--style3">
                                                    <img class="testimonial__thumbnail--style3__img display-block" src="https://source.unsplash.com/102x102?photos&tourism" alt="testimonial-img">
                                                </div>
                                                <div class="testimonial__style3--author">
                                                    <h3 class="testimonial__style3--author__title h4">Robert Bruze</h3>
                                                    <h4 class="testimonial__style3--author__subtitle h5">Product Designer</h4>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial__items--style3 border-radius-5">
                                            <div class="testimonial__style3--topbar text-center">
                                                <div class="testimonial__thumbnail--style3">
                                                    <img class="testimonial__thumbnail--style3__img display-block" src="https://source.unsplash.com/102x102?photos&selebgram" alt="testimonial-img">
                                                </div>
                                                <div class="testimonial__style3--author">
                                                    <h3 class="testimonial__style3--author__title h4">Robert Bruze</h3>
                                                    <h4 class="testimonial__style3--author__subtitle h5">Product Designer</h4>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html">
                                        <img class="blog__thumbnail--img display-block" src="https://source.unsplash.com/320x218?wood&furniture" alt="blog-img"></a>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html">
                                        <img class="blog__thumbnail--img display-block" src="https://source.unsplash.com/320x218?metal&furniture" alt="blog-img"></a>
                                </div>
                                <div class="blog__content text-center">
                                    <ul class="blog__content--meta d-flex justify-content-center">
                                        <li class="blog__content--meta__text">
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html">
                                        <img class="blog__thumbnail--img display-block" src="https://source.unsplash.com/320x218?bamboo&furniture" alt="blog-img"></a>
                                </div>
                                <div class="blog__content text-center">
                                    <ul class="blog__content--meta d-flex justify-content-center">
                                        <li class="blog__content--meta__text">
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html">
                                        <img class="blog__thumbnail--img display-block" src="https://source.unsplash.com/320x218?classic&furniture" alt="blog-img"></a>
                                </div>
                                <div class="blog__content text-center">
                                    <ul class="blog__content--meta d-flex justify-content-center">
                                        <li class="blog__content--meta__text">
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html">
                                        <img class="blog__thumbnail--img display-block" src="https://source.unsplash.com/320x218?modern&furniture" alt="blog-img"></a>
                                </div>
                                <div class="blog__content text-center">
                                    <ul class="blog__content--meta d-flex justify-content-center">
                                        <li class="blog__content--meta__text">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank" href="https://www.instagram.com/p/CZkF3TLBTT7" >
                                    <img class="instagram__thumbnail--img display-block" src="https://source.unsplash.com/256x312?armchair" alt="instagram-img">
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank" href="https://www.instagram.com/p/CZkF60sBxhN" >
                                    <img class="instagram__thumbnail--img display-block" src="https://source.unsplash.com/256x312?village&design" alt="instagram-img">
                                    <span class="instagram__social--icon"><svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewBox="0 0 25.198 25.199">
                                        <defs>
                                        <radialGradient  cx="0.133" cy="1.005" r="1.305" gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                            <stop offset="0.09" stop-color="#fa8f21"/>
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank" href="https://www.instagram.com/p/CZkF90ZB6HG" >
                                    <img class="instagram__thumbnail--img display-block" src="https://source.unsplash.com/256x312?bali&beach" alt="instagram-img">
                                    <span class="instagram__social--icon"><svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewBox="0 0 25.198 25.199">
                                        <defs>
                                        <radialGradient  cx="0.133" cy="1.005" r="1.305" gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                            <stop offset="0.09" stop-color="#fa8f21"/>
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank" href="https://www.instagram.com/p/CZkGAe6BQeu" >
                                    <img class="instagram__thumbnail--img display-block" src="https://source.unsplash.com/256x312?rajaampat" alt="instagram-img">
                                    <span class="instagram__social--icon"><svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewBox="0 0 25.198 25.199">
                                        <defs>
                                        <radialGradient  cx="0.133" cy="1.005" r="1.305" gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                            <stop offset="0.09" stop-color="#fa8f21"/>
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank" href="https://www.instagram.com/p/CZkGCWcBbv9" >
                                    <img class="instagram__thumbnail--img display-block" src="https://source.unsplash.com/256x312?labuanbajo" alt="instagram-img">
                                    <span class="instagram__social--icon"><svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewBox="0 0 25.198 25.199">
                                        <defs>
                                        <radialGradient  cx="0.133" cy="1.005" r="1.305" gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                            <stop offset="0.09" stop-color="#fa8f21"/>
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank" href="https://www.instagram.com/p/CZkGFDMhoid" >
                                    <img class="instagram__thumbnail--img display-block" src="https://source.unsplash.com/256x312?merapi" alt="instagram-img">
                                    <span class="instagram__social--icon"><svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewBox="0 0 25.198 25.199">
                                        <defs>
                                        <radialGradient  cx="0.133" cy="1.005" r="1.305" gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                            <stop offset="0.09" stop-color="#fa8f21"/>
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank" href="https://www.instagram.com/p/CZkGGnyh7jZ" >
                                    <img class="instagram__thumbnail--img display-block" src="https://source.unsplash.com/256x312?norwegia" alt="instagram-img">
                                    <span class="instagram__social--icon"><svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewBox="0 0 25.198 25.199">
                                        <defs>
                                        <radialGradient  cx="0.133" cy="1.005" r="1.305" gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                            <stop offset="0.09" stop-color="#fa8f21"/>
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank" href="https://www.instagram.com/p/CZkF3TLBTT7" >
                                    <img class="instagram__thumbnail--img display-block" src="https://source.unsplash.com/256x312?swiss" alt="instagram-img">
                                    <span class="instagram__social--icon"><svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewBox="0 0 25.198 25.199">
                                        <defs>
                                        <radialGradient  cx="0.133" cy="1.005" r="1.305" gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                            <stop offset="0.09" stop-color="#fa8f21"/>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('Afurea') }}/assets/img/product/big-product1.webp"><img class="product__media--preview__items--img" src="{{ asset('Afurea') }}/assets/img/product/big-product1.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{ asset('Afurea') }}/assets/img/product/big-product1.webp" data-gallery="product-media-preview">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('Afurea') }}/assets/img/product/big-product2.webp"><img class="product__media--preview__items--img" src="{{ asset('Afurea') }}/assets/img/product/big-product2.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{ asset('Afurea') }}/assets/img/product/big-product2.webp" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                    <span class="visually-hidden">Media Gallery</span>
                                                </a>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('Afurea') }}/assets/img/product/big-product3.webp"><img class="product__media--preview__items--img" src="{{ asset('Afurea') }}/assets/img/product/big-product3.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{ asset('Afurea') }}/assets/img/product/big-product3.webp" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                    <span class="visually-hidden">Media Gallery</span>
                                                </a>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('Afurea') }}/assets/img/product/big-product4.webp"><img class="product__media--preview__items--img" src="{{ asset('Afurea') }}/assets/img/product/big-product4.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{ asset('Afurea') }}/assets/img/product/big-product4.webp" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                    <span class="visually-hidden">Media Gallery</span>
                                                </a>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('Afurea') }}/assets/img/product/big-product5.webp"><img class="product__media--preview__items--img" src="{{ asset('Afurea') }}/assets/img/product/big-product5.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{ asset('Afurea') }}/assets/img/product/big-product5.webp" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                    <span class="visually-hidden">Media Gallery</span>
                                                </a>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('Afurea') }}/assets/img/product/big-product6.webp"><img class="product__media--preview__items--img" src="{{ asset('Afurea') }}/assets/img/product/big-product6.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{ asset('Afurea') }}/assets/img/product/big-product6.webp" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                    <span class="visually-hidden">Media Gallery</span>
                                                </a>
                                            </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{ asset('Afurea') }}/assets/img/product/small-product1.webp" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{ asset('Afurea') }}/assets/img/product/small-product2.webp" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{ asset('Afurea') }}/assets/img/product/small-product3.webp" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{ asset('Afurea') }}/assets/img/product/small-product4.webp" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{ asset('Afurea') }}/assets/img/product/small-product5.webp" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{ asset('Afurea') }}/assets/img/product/small-product6.webp" alt="product-nav-img">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper__nav--btn swiper-button-next"></div>
                                        ...
                                        <fieldset class="variant__input--fieldset">
                                            ...
                                            <div class="variant__color d-flex">
                                                <div class="variant__color--list">
                                                    ...
                                                    <label class="variant__color--value red" for="color-red1" title="Red"><img class="variant__color--value__img" src="{{ asset('Afurea') }}/assets/img/product/product1.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red2" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red2" title="Black"><img class="variant__color--value__img" src="{{ asset('Afurea') }}/assets/img/product/product6.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red3" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red3" title="Pink"><img class="variant__color--value__img" src="{{ asset('Afurea') }}/assets/img/product/product7.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red4" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red4" title="Orange"><img class="variant__color--value__img" src="{{ asset('Afurea') }}/assets/img/product/product4.webp" alt="variant-color-img"></label>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
        ...
        <div class="newsletter__popup--inner">
            ...
            <div class="box newsletter__popup--box d-flex align-items-center">
                <div class="newsletter__popup--thumbnail">
                    <img class="newsletter__popup--thumbnail__img display-block" src="{{ asset('Afurea') }}/assets/img/banner/newsletter-popup-thumb.png" alt="newsletter-popup-thumb">
                </div>
