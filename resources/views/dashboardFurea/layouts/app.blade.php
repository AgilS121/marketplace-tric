                        ...
                        <div class="hero__slider3--inner hero__slider--activation swiper">
                            ...
                            @if($loop->index == 0)
                                <div class="swiper-slide"  style="overflow : hidden; height: 40rem;">
                                    <div  style="background-image: url('{{ asset('storage/public/images/' . $dtc->image) }}');" class="hero__slider3--items hero__slider--bg3 slider1">
                                ...
                                @elseif($loop->index == 1)
                                    <div class="swiper-slide "  style="overflow : hidden; height: 40rem;">
                                    <div  style="background-image: url('{{ asset('storage/public/images/' . $dtc->image) }}');" class="hero__slider3--items hero__slider--bg2 slider2">
                                ...
                                <div class="swiper-slide" style="overflow : hidden; height: 40rem;">
                                    <div  style="background-image: url('{{ asset('storage/public/images/' . $dtc->image) }}'); display: flex; justify-content: flex-end;"  class="hero__slider3--items hero__slider--bg3 slider3" >
                    ...
                    <div class="row row-cols-lg-6 row-cols-md-4 row-cols-sm-3 row-cols-2  mb--n30">
                            ...
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('Afurea') }}/assets/img/product/categories-product1.webp"
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('Afurea') }}/assets/img/product/categories-product2.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('Afurea') }}/assets/img/product/categories-product3.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('Afurea') }}/assets/img/product/categories-product4.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('Afurea') }}/assets/img/product/categories-product5.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('Afurea') }}/assets/img/product/categories-product6.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('Afurea') }}/assets/img/product/categories-product7.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('Afurea') }}/assets/img/product/categories-product8.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('Afurea') }}/assets/img/product/categories-product9.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('Afurea') }}/assets/img/product/categories-product10.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('Afurea') }}/assets/img/product/categories-product11.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('Afurea') }}/assets/img/product/categories-product12.webp"
                                        alt="categories-product">
                                    ...
                                    <div class="product__items ">
                                        ...
                                        <img class="product__items--img product__secondary--img" src="{{ asset('Afurea') }}/assets/img/product/product2.webp" alt="product-img"> --}}
                                            ...
                                            <ul class="product__items--action d-flex justify-content-center">
                                                ...
                                                <li class="product__items--action__list">
                                                    <a class="psroduct__items--action__btn addwish" data-barang-id="{{ $item->id }}">
                                                        <svg class="product__items--action__btn--svg"
                                    ...
                                    <div class="product__items ">
                                        ...
                                        <img class="product__items--img product__secondary--img" src="{{ asset('Afurea') }}/assets/img/product/product12.webp" alt="product-img"> --}}
                                            ...
                                            <a class="product__items--action__btn" data-open="modal1"
                                                ...
                                                <li class="product__items--action__list">
                                                    <a class="product__items--action__btn addwish" data-barang-id="{{ $item->id }}" >
                                                        <svg class="product__items--action__btn--svg"
                                                            xmlns="http://www.w3.org/2000/svg" width="17.51"
                                                            height="15.443" viewBox="0 0 24.526 21.82">
                                                            <path
                                        ...
                                        <div class="product__items--content text-center">
                                            ...
                                            <a data-barang-id="{{$item->id}}" class="product__items--action__cart--btn primary__btn btn__style3 addcart"
                                                >
                                                <svg class="product__items--action__cart--btn__icon"
                                                    xmlns="http://www.w3.org/2000/svg" width="13.897" height="14.565"
                                                    viewBox="0 0 18.897 21.565">
