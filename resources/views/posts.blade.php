...
@section('container')
    ...
    @if ($posts->count())
        <div class="card mb-3">
            ...
            @else
                <img src="https://source.unsplash.com/800x250?{{ $posts[0]->category->name }}" class="card-img-top"
                    alt="{{ $posts[0]->category->name }}">
            @endif
            <div class="card-body text-center">
                ...
                <p>
                    <small>
                        By. <a href="/?user={{ $posts[0]->user->username }}"
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>
                                        <small>
                                            By. <a href="/?user={{ $post->user->username }}"
