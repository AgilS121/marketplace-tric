...
<head>
    ...
    <link rel="icon" href="{{ asset('Ashopus') }}/assets/images/homepage-one/icon.png">

    <!--title  -->
    <title>AShopus: Your One-Stop Destination for Fashion and Style</title>


    <!--------------- swiper-css ---------------->
    <link rel="stylesheet" href="{{ asset('Ashopus') }}/css/swiper10-bundle.min.css">

    <!--------------- bootstrap-css ---------------->
    <link rel="stylesheet" href="{{ asset('Ashopus') }}/css/bootstrap-5.3.2.min.css">

    <!---------------------- Range Slider ------------------->
    <link rel="stylesheet" href="{{ asset('Ashopus') }}/css/nouislider.min.css">

    <!---------------------- Scroll ------------------->
    <link rel="stylesheet" href="{{ asset('Ashopus') }}/css/aos-3.0.0.css">

    <!--------------- additional-css ---------------->
    <link rel="stylesheet" href="{{ asset('Ashopus') }}/css/style.css">
...
<body>
    ...
    <!--------------- header-section --------------->
    @include('dashboardShopus.layouts.header')
    <!--------------- header-section-end --------------->
    ...
    <!--------------- category-section--------------->
    @include('dashboardShopus.category')
                ...
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/brand-img-1.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/brand-img-2.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/brand-img-3.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/brand-img-4.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/brand-img-5.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/brand-img-6.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/brand-img-7.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/brand-img-8.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/brand-img-9.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/brand-img-10.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/brand-img-11.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/brand-img-12.webp" alt="img">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="arrival-section">
                <div class="row g-5">
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/product-img/product-img-1.webp"
                                    alt="product-img">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/product-img/product-img-2.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/product-img/product-img-3.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/product-img/product-img-4.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/product-img/product-img-5.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/product-img/product-img-6.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/product-img/product-img-7.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/product-img/product-img-8.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right" data-aos-duration="400">
                            <div class="product-img">
                                <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/product-img/product-img-9.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
            ...
            <div class="top-selling-section">
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/product-img/product-img-10.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
            ...
            <div class="best-product-section">
                <div class="row g-4">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/product-img/product-img-11.webp"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/product-img/product-img-13.webp"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/product-img/product-img-12.webp"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
    ...
    <!--------------- footer-section--------------->
    @include('dashboardShopus.layouts.footer')
    <!--------------- footer-section-end--------------->
    ...
    <!--------------- jQuery ---------------->
    <script src="{{ asset('Ashopus') }}/assets/js/jquery_3.7.1.min.js"></script>

    <!--------------- bootstrap-js ---------------->
    <script src="{{ asset('Ashopus') }}/assets/js/bootstrap_5.3.2.bundle.min.js"></script>

    <!--------------- Range-Slider-js ---------------->
    <script src="{{ asset('Ashopus') }}/assets/js/nouislider.min.js"></script>

    <!--------------- scroll-Animation-js ---------------->
    <script src="{{ asset('Ashopus') }}/assets/js/aos-3.0.0.js"></script>

    <!--------------- swiper-js ---------------->
    <script src="{{ asset('Ashopus') }}/assets/js/swiper10-bundle.min.js"></script>

    <!--------------- additional-js ---------------->
    <script src="{{ asset('Ashopus') }}/assets/js/shopus.js"></script>
