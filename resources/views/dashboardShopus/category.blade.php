        ...
        <div class="category-section">
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                <div class="wrapper-img">
                    <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/category-img/dresses.webp" alt="dress">
                </div>
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="200">
                <div class="wrapper-img">
                    <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/category-img/bags.webp" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="300">
                <div class="wrapper-img">
                    <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/category-img/sweaters.webp" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="400">
                <div class="wrapper-img">
                    <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/category-img/shoes.webp" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="500">
                <div class="wrapper-img">
                    <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/category-img/gift.webp" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="600">
                <div class="wrapper-img">
                    <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/category-img/sneakers.webp" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                <div class="wrapper-img">
                    <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/category-img/watch.webp" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="200">
                <div class="wrapper-img">
                    <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/category-img/ring.webp" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="300">
                <div class="wrapper-img">
                    <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/category-img/cap.webp" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="400">
                <div class="wrapper-img">
                    <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/category-img/glass.webp" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="500">
                <div class="wrapper-img">
                    <img src="{{ asset('Ashopus') }}/assets/images/homepage-one/category-img/baby.webp" alt="dress">
                </div>
                <div class="wrapper-info">
