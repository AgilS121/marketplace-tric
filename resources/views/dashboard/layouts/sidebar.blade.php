...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        ...
        @if (Auth::check())
            @if ($pp->store_logo)
                <img src="{{ asset('storage/public/images/' . $pp->store_logo) }}" alt="AdminLTE Logo"
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                @if (Auth::check())
                    @if (Auth::user()->image)
                        <img src="{{ asset('storage/public/images/' . Auth::user()->image) }}"
                            class="img-circle elevation-2" alt="User Image">
                    @else
                        <img src="tema/dist/img/user2-160x160.jpg" class="img-circle elevation-2"
                            alt="Default User Image">
                    @endif
                @else
                    <img src="tema/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="Default User Image">
                @endif
            </div>
            <div class="info">
