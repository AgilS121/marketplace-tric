...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.min.js" integrity="sha384-BBtl+eGJRgqQAUMxJ7pMwbEyER4l1g+O15P+16Ep7Q9Q+zqX6gSbd85u4mG4QzX+" crossorigin="anonymous"></script>
    ...
    <!-- DataTables -->
    <link href="{{ asset('tema/libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css') }}"
    ...
    <link rel="stylesheet"
        href="{{ asset('tema/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css') }}">
    ...
    {{-- SWAL --}}
    <link href="{{ asset('tema/plugins/sweetalert2/sweetalert2.min.css') }}" rel="stylesheet"
        type="text/css" />
...
<body class="hold-transition layout-top-nav  @if (session()->has('darkmode')) dark-mode @endif">
    ...
    <script src="{{ asset('tema/libs/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js') }}">
    </script>
