             ...
             <div class="row align-items-center">
                <div class="col-xl-3">
                   <div class="header__logo">
                      <a href="index.html"><img src="{{ asset('Afarm') }}/assets/img/logo/logo.png" alt="logo"></a>
                   </div>
                </div>
                <div class="col-xl-6">
                         ...
                         <ul>
                            <li class="has-dropdown has-homemenu">
                               ...
                               <ul class="sub-menu home-menu-style">
                                  <li>
                                     <a href="index.html"><img src="{{ asset('Afarm') }}/assets/img//header/home1-1.jpg" alt=""> Home Page V1</a>
                                  </li>
                                  <li>
                                     <a href="index-2.html"><img src="{{ asset('Afarm') }}/assets/img//header/home2-1.jpg" alt=""> Home Page V2</a>
                                  </li>
                                  <li>
                                     <a href="index-3.html"><img src="{{ asset('Afarm') }}/assets/img//header/home3-1.jpg" alt=""> Home Page V3</a>
                                  </li>
                                  <li>
                                     <a href="index-4.html"><img src="{{ asset('Afarm') }}/assets/img//header/home4-1.jpg" alt=""> Home Page V4</a>
                                  </li>
                                  <li>
                                     <a href="index-5.html"><img src="{{ asset('Afarm') }}/assets/img//header/home5-1.jpg" alt=""> Home Page V5</a>
                                  </li>
                                  <li>
                                     <a href="index-6.html"><img src="{{ asset('Afarm') }}/assets/img//header/home6-1.jpg" alt=""> Home Page V6</a>
                                  </li>
                               </ul>
                            </li>
                            <li class="has-dropdown has-megamenu" >
                               <a href="course-grid.html">Shop</a>
                               <ul class="sub-menu mega-menu" data-background="{{ asset('Afarm') }}/assets/img/banner/mega-menu-shop-1.jpg">
                                  <li>
                ...
                <div class="col-xl-3">
                   <div class="header__info d-flex align-items-center">
                      ...
                      <div class="header__info-cart tpcolor__oasis ml-10 tp-cart-toggle">
                         <button><i><img src="{{ asset('Afarm') }}/assets/img/icon/cart-1.svg" alt=""></i>
                            <span>5</span>
                         </button>
                      </div>
                   </div>
             ...
             <div class="tpcart__product-list">
                <ul>
                   <li>
                      <div class="tpcart__item">
                         <div class="tpcart__img">
                            <img src="{{ asset('Afarm') }}/assets/img/product/products1-min.jpg" alt="">
                   ...
                   <li>
                      <div class="tpcart__item">
                         <div class="tpcart__img">
                            <img src="{{ asset('Afarm') }}/assets/img/product/products12-min.jpg" alt="">
                            <div class="tpcart__del">
                               <a href="#"><i class="icon-x-circle"></i></a>
                            </div>
                         </div>
                   ...
                   <li>
                      <div class="tpcart__item">
                         <div class="tpcart__img">
                            <img src="{{ asset('Afarm') }}/assets/img/product/products3-min.jpg" alt="">
                            <div class="tpcart__del">
                               <a href="#"><i class="icon-x-circle"></i></a>
                            </div>
                         </div>
